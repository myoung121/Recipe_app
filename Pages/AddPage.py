...
class Add(
    ...
    def __init__(self, parent, controller, navigation_dict):
        ...
        # LABEL
        lbl_recipe_name = tk.Label(frame_entries_left, text='recipe name')
        lbl_recipe_name.grid(row=0, column=0)
        lbl_recipe_ingreds = tk.Label(frame_entries_right, text='recipe ingredients')
        lbl_recipe_ingreds.grid(row=2, column=0)
        # lbl_blank = tk.Label(frame_entries)
        # lbl_blank.grid(row=3, column=0, pady=20)
        lbl_recipe_ctime = tk.Label(frame_entries_right, text='recipe cooktime(mins)')
        lbl_recipe_ctime.grid(row=0, column=0)
        lbl_recipe_instrs = tk.Label(frame_entries_right, text='recipe instructions')
        lbl_recipe_instrs.grid(row=4, column=0)
        lbl_recipe_notes = tk.Label(frame_entries_left, text='recipe notes')
